                ...
                <div className="row align-items-center">
                    <div className="col-auto pr-5" style={{width: 530}}>
                        ...
                        <div className="row mt-5">
                            <div className="col-auto" style={{marginRight: 50}}>
                                <img width="36" height="36" src="images/icon_traveler.svg" alt={`${props.data.travelers} Travelers`}/>
                                <h6 className="mt-3">
                                    {props.data.travelers} <span className="text-gray-500 font-weight-light">Travelers</span>
                                </h6>
                            </div>
                            <div className="col-auto" style={{marginRight: 50}}>
                                <img width="36" height="36" src="images/icon_treasure.svg" alt={`${props.data.treasures} Treasures`}/>
                                <h6 className="mt-3">
                                    {props.data.treasures} <span className="text-gray-500 font-weight-light">Treasures</span>
                                </h6>
                            </div>
                            <div className="col-auto">
                                <img width="36" height="36" src="images/icon_cities.svg" alt={`${props.data.cities} Cities`}/>
                                <h6 className="mt-3">
                    ...
                    <div className="col-6 pl-5">
                        <div style={{width: 520, height: 410}}>
                            ...
                            <img src={ImageHero_} alt="Room with couches frame" className="img-fluid position-absolute" style={{margin: "1 15px 15px 0"}} />
                        </div>
                    </div>
                </div>      
            </section>
